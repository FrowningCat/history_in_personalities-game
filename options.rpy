...
define config.name = _("History in personalities")
...
define gui.about = _p("""
История, как наука о прошлом, играет большую роль в жизни современного человека, хоть на первый взгляд так и не кажеться. Человек, хорошо знающий историю, не только своей страны, но и других, в меньшей степени подвержен влиянию пропаганды, ему легче понять когда и зачем искажается информация властью, политиками или собеседником, его предположения по поводу возможных последствий от различных действий более взвешенные и учитывают большее количество факторов и возможных последствий, кроме того, он имеет более критический взгляд на мир.
""")
...
define build.name = "Historyinpersonalities"
...
define config.main_menu_music = "New-Composition-16.ogg"
...
define config.save_directory = "Historyinpersonalities-1705036963"
